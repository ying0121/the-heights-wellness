...
exports.sendEmail = async (req, res, next) => {
	...
	const htmlContents = await ejs.renderFile(path.join(__dirname, '../../views/email/surveyemail.ejs'), emailConfig)
...
exports.sendResultEmail = async (req, res, next) => {
	...
	if (emails) {
		...
		const htmlContents = await ejs.renderFile(path.join(__dirname, '../../views/email/surveyresultemail.ejs'), emailConfig)
